...
async function addBotulinumProducts() {
  try {
    console.log('Starting to add Botulinum Toxin products...');
    ...
    console.log(`Found Botulinum Toxins category with ID: ${categoryId}`);
    ...
    console.log(`\n🎉 Successfully processed ${botulinum_products.length} Botulinum Toxin products`);
  } catch (error) {
...
export { addBotulinumProducts, botulinum_products };